...
test("ships the comparison imagery and full-stack interaction hooks", async () => {
  ...
  await access(new URL("../public/coordinatez-patio-panorama-v2.avif", import.meta.url));
  await access(new URL("../public/coordinatez-desert-panorama.avif", import.meta.url));
  ...
  await access(new URL("../public/coordinatez-lifestyle-pool.avif", import.meta.url));
  ...
  assert.match(page, /coordinatez-desert-panorama\.avif/);
